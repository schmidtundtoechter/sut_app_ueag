...
fixtures = [
    ...
    #             'Employee-custom_tätigkeitsbezeichnung_2' , 
    #             'Employee-custom_tätigkeitsbezeichnung_3' , 
    #             'Employee-custom_tätigkeitsbezeichnung_4' , 
    #             'Employee-custom_tätigkeitsbezeichnung_1_iv' , 
    #             'Employee-custom_tätigkeitsbezeichnung_2_iv' , 
    #             'Employee-custom_tätigkeitsbezeichnung_3_iv' , 
    ...
    } , 
    {
        ...
        "filters": [
            ["name", "in", [
                ...
                "ÜAG Fachgebietsleitung Schulbegleitung" , 
                "ÜAG Fachgebietsleitung Aus- und Weiterbildung" ,
                "ÜAG Fachgebietsleitung stat. Hilfen zur Erziehung",
                "ÜAG Büroleitung Geschäftsführung" ,
                "ÜAG Bereichsleitung Arbeit" , 
                "ÜAG Bereichsleitung Beratung & Integration"

                            ]]
        ]
    },
    {
        "doctype": "Abteilung fuer DATEV Lodas Export",
        "filters": [
            ["name", "in", [
                "1-Bildung" , 
                "2-Bildung" , 
                "9-Geschäftsführung & Verwaltung",
                "4-Beratung & Integration",
                "3-inJena"
